"""Tests for gtja191 batch 061-080."""
...
from aurumq_rl.factors.gtja191.batch_061_080 import (
    gtja_061,
    gtja_062,
    gtja_063,
    gtja_064,
...
_XFAIL_PARITY: set[str] = {
    ...
    # gtja_075 is a benchmark factor (CSI300 proxy mismatch); others likely
    # need the `turn` (turnover_rate) column or have argmax tie-rule drift.
    "gtja_063", "gtja_067", "gtja_075", "gtja_077", "gtja_079",
}
