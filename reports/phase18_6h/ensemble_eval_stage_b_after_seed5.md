# Ensemble eval — stage_b_after_seed5
...
| ensB_after_seed5_zmean | zmean | 16a+17d+17b+1818a+1818b | +1.769 | +0.603 | +1.297 | +0.0272 | +0.175 |
| single_1818b | passthrough | 1818b | +1.761 | +0.596 | +1.368 | +0.0175 | +0.168 |
| single_16a | passthrough | 16a | +1.593 | +0.428 | +1.112 | +0.0143 | -0.000 |
| ensB_after_seed5_rankmean | rankmean | 16a+17d+17b+1818a+1818b | +1.541 | +0.376 | +1.209 | +0.0273 | -0.052 |
| single_17d | passthrough | 17d | +1.514 | +0.348 | +1.690 | +0.0087 | -0.080 |
| ensB_after_seed5_zmedian | zmedian | 16a+17d+17b+1818a+1818b | +1.507 | +0.341 | +0.713 | +0.0235 | -0.087 |
